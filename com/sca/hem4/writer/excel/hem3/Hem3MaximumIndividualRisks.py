...
notes = 'notes';
warning = 'warning'
class Hem3MaximumIndividualRisks(ExcelWriter, InputFile):
    """
    ...
    def getColumns(self):
        return [parameter, value, value_rnd, value_sci, population, distance, angle, elev,
                hill, fips, block, utme, utmn, lat, lon, rec_type, notes, warning]
    ...
    def createDataframe(self):
        ...
        self.numericColumns = [value, value_rnd, population, distance, angle, elev, hill, utme, utmn, lat, lon]
        self.strColumns = [parameter, fips, block, value_sci, rec_type, notes, warning]
