...
class Hem3RingSummaryChronic(CsvWriter, InputFile):
    """
    ...
    def getHeader(self):
        return ['X', 'Y', 'Latitude', 'Longitude', 'Overlap', 'Distance (m)', 'Angle (from north)', 'Sector',
                'Elevation (m)', 'Hill', 'MIR',
    ...
    def getColumns(self):
        return [utme, utmn, lat, lon, overlap, distance, angle, sector, elev, hill, mir, hi_resp, hi_live, hi_neur,
